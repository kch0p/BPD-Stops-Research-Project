...
log using "E:\MyMcGill\Governance\Governance\Log\LOG `study'-`c_date'.log", replace

use "E:\MyMcGill\Governance\Governance\Data\cr_afro_r5_2015_update.dta", clear
...
reg lpi egrid pwater sewage road   //Model 1
	outreg2 using "E:\MyMcGill\Governance\Governance\Results\`study'-`c_date'.xls", dec(3) alpha(0.001, 0.01, 0.05) symbol(***, **, *) replace
reg lpi egrid pwater sewage road ps army   //Model 2
	outreg2 using "E:\MyMcGill\Governance\Governance\Results\`study'-`c_date'.xls", dec(3) alpha(0.001, 0.01, 0.05) symbol(***, **, *) append
